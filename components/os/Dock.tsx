...
> = {
  ...
  calculator:{ name: "Calculator",Icon: Calculator, bg: "linear-gradient(145deg,#f59e0b,#d97706)", color: "#fff",    titlebarBg: "#f5e4c8", iconLight: "/icons/calculator.jpg", iconDark: "/icons/calculator.jpg" },
  about:     { name: "About Me",   Icon: Fingerprint, bg: "linear-gradient(145deg,#a855f7,#6d28d9)", color: "#fff",    titlebarBg: "#e8d8f0", iconLight: "/icons/about-me.jpg", iconDark: "/icons/about-me.jpg" },
